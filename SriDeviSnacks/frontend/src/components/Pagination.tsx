...
export const Pagination = ({ currentPage, totalPages, onPageChange }: { currentPage: number; totalPages: number; onPageChange: (page: number) => void }) => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between px-6 py-3 bg-white border-t border-gray-200">
      <div className="flex flex-wrap items-center w-full md:w-auto mb-2 md:mb-0">
        <button
      ...
      <div className="w-full md:w-auto text-sm text-gray-700 text-center md:text-right">
