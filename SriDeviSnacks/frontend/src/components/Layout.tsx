        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            {userRole === 'SUPER_ADMIN' ? (
              <Link to="/admin/landing-settings" className="flex-shrink-0 flex items-center px-4 cursor-pointer hover:opacity-80 transition" onClick={() => setSidebarOpen(false)}>
      ...
      <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            {userRole === 'SUPER_ADMIN' ? (
              <Link to="/admin/landing-settings" className="flex items-center flex-shrink-0 px-4 cursor-pointer hover:opacity-80 transition">
                <img src={Logo} alt="Sri Devi Snacks Logo" className="h-8 w-8 mr-2" />
                <span className="text-2xl font-bold text-gray-900">Sri Devi Snacks</span>
              </Link>
            ) : (
